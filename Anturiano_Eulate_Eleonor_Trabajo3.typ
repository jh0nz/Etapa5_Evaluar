...
#let evaluacion = (
  ...
  ( // 2. Correspondencia entre el sistema y el mundo real
    (puntuacion: 0.5, nota:"Los nombres de las secciones son comprensibles y formales, como “Misión”, “Visión” o “Metas y Objetivos”. Sin embargo, algunas etiquetas se presentan abreviadas, por ejemplo “Manual de Fun.”, lo cual afecta la claridad y la presentación visual del contenido.", evidencia: image("images/Evidencia-manualfun.png")), // ¿El lenguaje del sitio coincide con el del público objetivo (no técnico)?
    (puntuacion: 0.5,), // ¿Los íconos y metáforas visuales representan correctamente su función?
  ...
  ( // 3. Control y libertad del usuario
    ...
    (puntuacion: 0.5,nota:"No existe una opción clara dentro del sitio para regresar al inicio o a la página anterior. Por lo que el usuario depende del botón “Atrás” del navegador para retroceder.", evidencia: image("images/Evidencia-volver.png")), // ¿El flujo de navegación permite volver fácilmente a pantallas previas?
    (puntuacion: 0.5,nota:"El botón “Inicio” del menú lateral es poco visible y no se diferencia de otros enlaces.", evidencia: image("images/Evidencia-inicio.png")), // ¿Existen atajos o botones de 'volver al inicio'?
  ),
  ( // 4. Consistencia y estándares
    (puntuacion: 0.5,), // ¿Los botones, colores y estilos mantienen el mismo comportamiento?
    (puntuacion: 1), // ¿Las palabras y acciones son coherentes en todo el sitio?
    (puntuacion: 0.5,nota:"El sitio muestra todos los subapartados del menú “Generalidades” sin resaltar la sección activa, lo que confunde al usuario.", evidencia: image("images/Evidencia-metasobjetivos.png")), // ¿Se siguen las convenciones comunes de diseño?
    (puntuacion: 1), // ¿El sitio usa patrones estándar de navegación?
    (puntuacion: 0.5,nota:"La página tiene una baja adaptabilidad a dispositivos móviles, presentando problemas de visualización y navegación en pantallas pequeñas",evidencia:  image("images/jhon-consistencia-mobile-desktop.png", height: 10cm)), // ¿La experiencia es consistente entre móvil y escritorio?
  ),
  ( // 5. Prevención de errores
    ...
    (puntuacion: 0.5,nota:"El enlace “Webmaster” no ofrece ninguna confirmación ni mensaje sobre su función o destino. El usuario no sabe hacia dónde lo llevará, y el sitio no previene clics innecesarios o repetidos. Esto genera incertidumbre sobre la acción realizada.", evidencia:image("images/Eleonor_PieDePagina.png")), // ¿Reduce el riesgo de errores de clic o confusión?
  ...
  ( // 7. Flexibilidad y eficiencia de uso
    ...
    (puntuacion: 0.5, nota:  "No hay atajos de navegación. Los usuarios deben desplazarse manualmente entre secciones solamente mediante el menú, lo que vuelve el proceso lento y poco eficiente.", evidencia: image("images/prueba_ejemplo.png")), // ¿Las tareas comunes se realizan en pocos pasos?
  ...
  ( // 8. Estética y diseño minimalista
    (puntuacion: 0.5), // ¿El diseño evita elementos o textos innecesarios?
    (puntuacion: 0.5), // ¿La jerarquía visual guía la atención a lo importante?
    (puntuacion: 0.5), // ¿Cada elemento tiene un propósito funcional?
    (puntuacion: 0.5), // ¿La combinación de colores y tipografía mejora legibilidad?
    (puntuacion: 0.5,nota:"La página presenta una sobrecarga de texto en paginas como ser “MANUAL DE FUNCIONES”. Los colores son planos, no se utilizan íconos ni elementos gráficos que orienten la lectura. Aunque la información es completa, su presentación dificulta la comprensión rápida.", evidencia: image("images/Evidencia-sobrecargadetexto.png")), // ¿Mantiene equilibrio entre estética y funcionalidad?
  ),
  ...
  ( // 10. Ayuda y documentación
    (puntuacion: 0,nota:"No existe una sección de ayuda ni soporte accesible. El único enlace disponible es “Webmaster”, ubicado al final de la página, pero no ofrece una redirección funcional.",evidencia: image("images/Eleonor_PieDePagina.png")), // ¿Existe una sección de ayuda o soporte visible?
    (puntuacion: 0), // ¿La ayuda está enfocada en tareas concretas?
    (puntuacion: 0.5), // ¿Es breve, clara y fácil de buscar?
    (puntuacion: 0.5), // ¿Hay opciones de contacto o asistencia inmediata?
...
#align(center)[
  ...
  #table(
    ...
    align: (left, left),
    inset: 8pt,
    [*Estudiante:*], [#upper[Anturiano Eulate Eleonor Camile]],
    [*Código:*], [202206250],
    [*Grupo:*], [API],
    [*Fecha:*], [30/10/2025],
