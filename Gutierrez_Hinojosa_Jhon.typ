...
#let datos = (
  estudiante: "Gutiérrez Hinojosa Jhon Deymar",
  grupo: "API",
  fecha: datetime(
    year: 2025,
    month: 12,
...
#let evaluacion = (
  ...
  (
    ...
    (
      ...
      extra: [
        *Nota:*
        Se emplea un ícono interactivo con el título "Reseña Histórica" que redirige al apartado "Acerca del Posgrado FCyT". Sin embargo, los nombres de las secciones no corresponden, lo que genera confusión. Además, ningún botón interactuable cuenta con una etiqueta textual que indique su interactividad.
